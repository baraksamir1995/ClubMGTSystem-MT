...
BEGIN
  ...
  -- session_date + start_time are stored in the gym's local timezone.
  -- Convert CURRENT_TIMESTAMP (UTC tz-aware) into that local wall time.
...
SQL);
    ...
    {
        // No rollback — previous definition used UTC wall time which is the bug we fix.
    }
};
