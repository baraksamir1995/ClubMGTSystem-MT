  ...
  return (
    <div className="relative">
      ...
      <div className="absolute -left-8 -bottom-10 w-[140px] md:w-[180px] z-0 hidden sm:block rotate-[-6deg]">
        <div className="relative rounded-[28px] border-[6px] border-ink bg-ink overflow-hidden shadow-2xl">
          <div className="aspect-[9/19.5] bg-canvas p-3 flex flex-col text-[8px] md:text-[10px]">
            <div className="flex items-center justify-between text-ink/60 font-mono pt-1 px-1">
              <span>9:41</span>
              <span>●●●●</span>
            </div>
            ...
            <div className="mt-3 rounded-lg bg-ink text-canvas p-2">
            ...
            <div className="mt-2 grid grid-cols-2 gap-1.5">
              <div className="rounded-md bg-accent/10 border border-accent/20 p-1.5">
                <div className="text-[6px] font-mono uppercase text-accent">Today</div>
                <div className="text-[9px] font-semibold leading-tight mt-0.5">HIIT · 6pm</div>
              </div>
              <div className="rounded-md bg-paper border border-line p-1.5">
            ...
            <div className="mt-auto pb-2 flex justify-around">
              <div className="h-1 w-6 rounded-full bg-ink" />
              <div className="h-1 w-6 rounded-full bg-ink/20" />
              <div className="h-1 w-6 rounded-full bg-ink/20" />
              <div className="h-1 w-6 rounded-full bg-ink/20" />
            </div>
          </div>
      ...
      <div className="relative z-10 rounded-lg border border-ink/10 bg-paper overflow-hidden shadow-[0_40px_80px_-40px_rgba(10,14,26,0.35)]">
        {/* browser chrome */}
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="flex items-start justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="h-6 w-6 rounded-full bg-accent flex items-center justify-center text-[10px] text-canvas font-medium">
                A
              </div>
            </div>
          </div>
          ...
          {/* Chart */}
          <div className="mt-4 rounded-md border border-ink/10 bg-canvas p-3 md:p-4">
...
function KPICard({
  ...
  return (
    <div className="rounded-md border border-ink/10 bg-canvas p-2.5 md:p-3">
...
function ActivityRow({
  ...
  return (
    <div className="flex items-center justify-between text-xs md:text-sm">
      <span className={accent ? "text-ink" : "text-ink/80"}>{text}</span>
      <span
        className={`font-mono text-[10px] md:text-xs tabular ${
          accent ? "text-accent font-medium" : "text-muted"
        }`}
      >
        {amount}
      </span>
